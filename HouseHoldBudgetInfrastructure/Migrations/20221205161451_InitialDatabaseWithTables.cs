...
{
    public partial class InitialDatabaseWithTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Loans/Mortgage" },
                    { 2, null, "Transportation" },
                    { 3, null, "Food" },
                    { 4, "Utilities generally include your gas, electricity, water, and sewage bills", "Utilities" },
                    { 5, "Medical care, dental appointments", "Medical & Healthcare" },
                    { 6, null, "Clothes and shoes" },
                    { 7, null, "Hobbies" },
                    { 8, null, "Vacation" },
                    { 9, null, "Restaurants" },
                    { 10, null, "Home decor and furnishings" },
                    { 11, null, "Saving" },
                    { 12, null, "Investing" },
                    { 13, null, "Others" }
                });
